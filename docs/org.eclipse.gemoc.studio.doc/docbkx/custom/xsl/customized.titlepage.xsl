...
<xsl:template name="article.titlepage.recto">
  ...
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/date"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/date"/>
...
<xsl:template name="set.titlepage.recto">
  ...
  <xsl:apply-templates mode="set.titlepage.recto.auto.mode" select="setinfo/date"/>
  <xsl:apply-templates mode="set.titlepage.recto.auto.mode" select="info/date"/>

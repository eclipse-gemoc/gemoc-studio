...
public class ProjectTemplateApplicationOperation extends WorkspaceModifyOperation {
	 ...
	 */
	public ProjectTemplateApplicationOperation(BaseProjectWizardFields data, IProject project, IProjectContentWizard contentWizard) {
		fData = data;
		fProject = project;
...
*/
		...
		if (fContentWizard != null) {
			contentWizardResult = fContentWizard.performFinish(fProject,  new SubProgressMonitor(monitor, 1));
		}

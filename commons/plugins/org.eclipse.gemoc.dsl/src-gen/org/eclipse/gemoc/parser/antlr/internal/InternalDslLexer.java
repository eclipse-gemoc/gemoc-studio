...
public class InternalDslLexer extends Lexer {
    ...
    public final void mRULE_SEPARATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDsl.g:444:16: ( ( '=' | ':' ) )
            // InternalDsl.g:444:18: ( '=' | ':' )
            {
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDsl.g:446:17: ( ( '!' | '#' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalDsl.g:446:19: ( '!' | '#' ) (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            if ( input.LA(1)=='!'||input.LA(1)=='#' ) {
                input.consume();
    ...
    public final void mRULE_LETTER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDsl.g:448:13: ( (~ ( ( RULE_SEPARATOR | RULE_SPACE | '\\\\\\n' | '\\r' | '\\n' ) ) | '\\\\=' | '\\\\:' | '\\\\#' | '\\\\!' ) )
            // InternalDsl.g:448:15: (~ ( ( RULE_SEPARATOR | RULE_SPACE | '\\\\\\n' | '\\r' | '\\n' ) ) | '\\\\=' | '\\\\:' | '\\\\#' | '\\\\!' )
            {
            // InternalDsl.g:448:15: (~ ( ( RULE_SEPARATOR | RULE_SPACE | '\\\\\\n' | '\\r' | '\\n' ) ) | '\\\\=' | '\\\\:' | '\\\\#' | '\\\\!' )
            int alt4=5;
            ...
            switch (alt4) {
                case 1 :
                    // InternalDsl.g:448:16: ~ ( ( RULE_SEPARATOR | RULE_SPACE | '\\\\\\n' | '\\r' | '\\n' ) )
                    {
    ...
    public final void mRULE_SPACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDsl.g:450:12: ( ( ' ' | '\\t' ) )
            // InternalDsl.g:450:14: ( ' ' | '\\t' )
            {
            if ( input.LA(1)=='\t'||input.LA(1)==' ' ) {
                input.consume();

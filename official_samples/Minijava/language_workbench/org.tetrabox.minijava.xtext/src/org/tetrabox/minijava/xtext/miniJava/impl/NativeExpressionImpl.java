 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.minijava.xtext.miniJava.impl.NativeExpressionImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NativeExpressionImpl extends ExpressionImpl implements NativeExpression {
	...
	protected EClass eStaticClass() {
		return MiniJavaPackage.Literals.NATIVE_EXPRESSION;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MiniJavaPackage.NATIVE_EXPRESSION__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MiniJavaPackage.NATIVE_EXPRESSION__VALUE:
				return getValue();
		}

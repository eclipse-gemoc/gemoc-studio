...
@ServerEndpoint("/mep/minijavarepl/trace")
@ApplicationScoped
public class AleMiniJava_replTraceManagerAddonServerEndpoint {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(AleMiniJava_replTraceManagerAddonServerEndpoint.class);
	...
	public TraceManagerAddonProtocolServer getOrCreateServer() {
		if(server == null) {
			FakeOSGI.start();
			IRemoteTraceAddon traceAddon = new AleMiniJava_replMEPModule().createInjectorAndDoEMFRegistration().getInstance(RemoteTraceManagerAddon.class);
    ...
    void onStart(@Observes StartupEvent ev) {               
        LOGGER.info("The AleMiniJavaTraceManagerAddonServerEndpoint is starting...");

...
@ClientEndpoint
@ApplicationScoped
public class AleMiniJavaTraceExplorerClientEndpoint {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(AleMiniJavaTraceExplorerClientEndpoint.class);
	...
	AleMiniJavaTraceManagerAddonClientEndpoint traceAddon;
	
	public AleMiniJavaTraceExplorerClientEndpoint(AleMiniJavaTraceManagerAddonClientEndpoint traceAddon) {
	...
	public TraceExplorerProtocolClient getOrCreateClient() {
		if(client == null) {
			...
			AleMiniJavaTraceManagerAddonClientEndpoint.instance.getOrCreateClient().setTraceExplorer(client);
		}
		return client;
	}

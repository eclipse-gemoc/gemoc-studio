...
@ServerEndpoint("/mep/minijava/omniscient")
@ApplicationScoped
public class AleMiniJavaOmniscientDebugServerEndpoint {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(AleMiniJavaOmniscientDebugServerEndpoint.class);
    ...
    void onStart(@Observes StartupEvent ev) {               
        LOGGER.info("The AleMiniJavaOmniscientDebugServerEndpoint is starting...");

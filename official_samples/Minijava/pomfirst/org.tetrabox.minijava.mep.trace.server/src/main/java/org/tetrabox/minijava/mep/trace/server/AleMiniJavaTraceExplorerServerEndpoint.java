...
@ServerEndpoint("/mep/minijava/trace/explorer")
@ApplicationScoped
public class AleMiniJavaTraceExplorerServerEndpoint {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(AleMiniJavaTraceExplorerServerEndpoint.class);

...
public class StateMachineAdapter extends EObjectAdapter<StateMachine> implements org.eclipse.gemoc.example.melangek3fsm.fsm.StateMachine {
  ...
  public void setInitialState(final State o) {
    if (o != null)
    	adaptee.setInitialState(((org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.adapters.fsmmt.fsm.StateAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.eINSTANCE.getStateMachine();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.STATE_MACHINE__NAME:
    		return getName();
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.STATE_MACHINE__OWNED_STATES:
    		return getOwnedStates();
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.STATE_MACHINE__INITIAL_STATE:
    		return getInitialState();
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.STATE_MACHINE__OWNED_TRANSITIONS:

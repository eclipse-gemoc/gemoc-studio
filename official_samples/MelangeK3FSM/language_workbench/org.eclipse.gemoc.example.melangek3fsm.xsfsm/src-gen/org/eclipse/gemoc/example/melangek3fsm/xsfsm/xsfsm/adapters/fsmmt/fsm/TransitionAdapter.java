...
public class TransitionAdapter extends EObjectAdapter<Transition> implements org.eclipse.gemoc.example.melangek3fsm.fsm.Transition {
  ...
  public void setSource(final State o) {
    if (o != null)
    	adaptee.setSource(((org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.adapters.fsmmt.fsm.StateAdapter) o).getAdaptee());
  ...
  public void setTarget(final State o) {
    if (o != null)
    	adaptee.setTarget(((org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.adapters.fsmmt.fsm.StateAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.eINSTANCE.getTransition();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.TRANSITION__NAME:
    		return getName();
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.TRANSITION__SOURCE:
    		return getSource();
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.TRANSITION__TARGET:
    		return getTarget();
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.TRANSITION__INPUT:
    		return getInput();
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.TRANSITION__OUTPUT:
    		return getOutput();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.TRANSITION__SOURCE:
    		setSource(
    		(org.eclipse.gemoc.example.melangek3fsm.fsm.State)
    		 newValue);
    		return;
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.TRANSITION__TARGET:
    		setTarget(

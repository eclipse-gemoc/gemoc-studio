...
public class TransitionAdapter extends EObjectAdapter<Transition> implements org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsmmt.fsm.Transition {
  ...
  public void setSource(final State o) {
    if (o != null)
    	adaptee.setSource(((org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.adapters.xsfsmmt.fsm.StateAdapter) o).getAdaptee());
  ...
  public void setTarget(final State o) {
    if (o != null)
    	adaptee.setTarget(((org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.adapters.xsfsmmt.fsm.StateAdapter) o).getAdaptee());
    else adaptee.setTarget(null);
  }
  
  @Override
  public void fire() {
    org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.aspects.TransitionAspect.fire(adaptee);
  }
  ...
  public EClass eClass() {
    return org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsmmt.fsm.FsmPackage.eINSTANCE.getTransition();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsmmt.fsm.FsmPackage.TRANSITION__NAME:
    		return getName();
    	case org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsmmt.fsm.FsmPackage.TRANSITION__SOURCE:
    		return getSource();
    	case org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsmmt.fsm.FsmPackage.TRANSITION__TARGET:
    		return getTarget();
    	case org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsmmt.fsm.FsmPackage.TRANSITION__INPUT:
    		return getInput();
    	case org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsmmt.fsm.FsmPackage.TRANSITION__OUTPUT:
    		return getOutput();
    }

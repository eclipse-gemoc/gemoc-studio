...
public class NamedElementAdapter extends EObjectAdapter<NamedElement> implements org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsmmt.fsm.NamedElement {
  ...
  public EClass eClass() {
    return org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsmmt.fsm.FsmPackage.eINSTANCE.getNamedElement();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsmmt.fsm.FsmPackage.NAMED_ELEMENT__NAME:
    		return getName();
    }

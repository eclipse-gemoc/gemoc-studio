...
public class StateAdapter extends EObjectAdapter<State> implements org.eclipse.gemoc.example.melangek3fsm.fsm.State {
  ...
  public void setOwningFSM(final StateMachine o) {
    if (o != null)
    	adaptee.setOwningFSM(((org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.adapters.fsmmt.fsm.StateMachineAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.eINSTANCE.getState();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.STATE__NAME:
    		return getName();
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.STATE__OWNING_FSM:
    		return getOwningFSM();
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.STATE__OUTGOING_TRANSITIONS:
    		return getOutgoingTransitions();
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.STATE__INCOMING_TRANSITIONS:
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.STATE__OWNING_FSM:
    		setOwningFSM(
    		(org.eclipse.gemoc.example.melangek3fsm.fsm.StateMachine)
    		 newValue);
    		return;
    	case org.eclipse.gemoc.example.melangek3fsm.fsm.FsmPackage.STATE__OUTGOING_TRANSITIONS:

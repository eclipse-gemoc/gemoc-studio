...
public class FsmTraceConstructor implements ITraceConstructor {
		...
		if (lastState == null) {
			...
			for (Resource r : allResources) {
				for (TreeIterator<EObject> i = r.getAllContents(); i.hasNext();) {
					...
					if (o instanceof org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.NamedElement) {
						org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.NamedElement o_cast = (org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.NamedElement) o;
	...
	private boolean addNewObjectToState(org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.NamedElement o_cast,
		...
		boolean added = false;
		if (o_cast instanceof org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.Transition) {
			...
			added = addNewObjectToState((org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.State) o_cast, newState);
	...
	private boolean addNewObjectToState(org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.State o_cast,
			fsmTrace.States.SpecificState newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject.setOriginalObject((org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.State) o_cast);
	...
	private boolean addNewObjectToState(org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.StateMachine o_cast,
			fsmTrace.States.SpecificState newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject.setOriginalObject((org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.StateMachine) o_cast);
			exeToTraced.put(o_cast, tracedObject);
			traceRoot.getTracedObjects().add(tracedObject);
			...
			if (o_cast.getCurrentState() != null) {
				addNewObjectToState((org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.State) o_cast.getCurrentState(),
						newState);
	...
	private boolean addNewObjectToState(org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.Transition o_cast,
			fsmTrace.States.SpecificState newState) {
		boolean added = false;
		...
		if (!added && !exeToTraced.containsKey(o_cast)) {
			...
			tracedObject.setOriginalObject((org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.Transition) o_cast);
			exeToTraced.put(o_cast, tracedObject);
			traceRoot.getTracedObjects().add(tracedObject);

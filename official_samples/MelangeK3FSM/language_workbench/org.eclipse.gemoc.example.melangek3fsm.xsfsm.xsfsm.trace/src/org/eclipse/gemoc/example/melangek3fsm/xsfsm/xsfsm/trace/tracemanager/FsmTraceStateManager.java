	...
	private void restoreStateExecute(fsmTrace.States.SpecificState state) {
		for (fsmTrace.States.SpecificValue value : state.getValues()) {
			if (value instanceof fsmTrace.States.StateMachine_consummedString_Value) {
				...
				org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.StateMachine exeObject = (org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.StateMachine) getTracedToExe(
						tracedObject);
				...
				exeObject.setCurrentState(
						(org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.State) (org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.State) getTracedToExe(

 ...
 * @generated
 */
public class FsmTraceFactoryImpl extends EFactoryImpl implements FsmTraceFactory {
	/**
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case FsmTracePackage.SPECIFIC_TRACE: return createSpecificTrace();
			default:
	 ...
	 */
	@Deprecated
	public static FsmTracePackage getPackage() {
		return FsmTracePackage.eINSTANCE;
	}

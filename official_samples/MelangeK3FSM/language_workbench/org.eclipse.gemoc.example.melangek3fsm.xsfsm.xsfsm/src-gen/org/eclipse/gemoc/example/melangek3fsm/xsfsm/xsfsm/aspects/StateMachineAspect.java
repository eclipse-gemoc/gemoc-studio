...
import org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.aspects.StateAspect;
...
public class StateMachineAspect {
  ...
  public static void main(final StateMachine _self) {
	final org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.aspects.StateMachineAspectStateMachineAspectProperties _self_ = org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.aspects.StateMachineAspectStateMachineAspectContext
			.getSelf(_self);
  ...
  public static void initializeModel(final StateMachine _self, final EList<String> args) {
    final org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.aspects.StateMachineAspectStateMachineAspectProperties _self_ = org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.aspects.StateMachineAspectStateMachineAspectContext.getSelf(_self);
    // #DispatchPointCut_before# void initializeModel(EList<String>)
    if (_self instanceof org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.StateMachine){
    	fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    		@Override
    		public void execute() {
    			org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.aspects.StateMachineAspect._privk3_initializeModel(_self_, (org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.StateMachine)_self,args);
    		}
    	};
  ...
  public static State currentState(final StateMachine _self) {
	...
	;
	return (org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.State) result;
}
    	...
    	for (java.lang.reflect.Method m : _self.getClass().getMethods()) {
    		if (m.getName().equals("getCurrentState") &&
    			m.getParameterTypes().length == 0) {
    				...
    				if (ret != null) {
    					return (org.eclipse.gemoc.example.melangek3fsm.xsfsm.xsfsm.fsm.State) ret;
    				} else {
    					return null;
    				}
    		}

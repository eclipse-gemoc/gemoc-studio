 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.sample.legacyfsm.fsm.State#getOwningFSM <em>Owning FSM</em>}</li>
 *   <li>{@link org.gemoc.sample.legacyfsm.fsm.State#getOutgoingTransitions <em>Outgoing Transitions</em>}</li>
 *   <li>{@link org.gemoc.sample.legacyfsm.fsm.State#getIncomingTransitions <em>Incoming Transitions</em>}</li>
 * </ul>
 *
...
public interface State extends NamedElement {
	 ...
	 * It is bidirectional and its opposite is '{@link org.gemoc.sample.legacyfsm.fsm.Transition#getSource <em>Source</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.gemoc.sample.legacyfsm.fsm.FsmPackage#getState_OutgoingTransitions()
	 ...
	 * The list contents are of type {@link org.gemoc.sample.legacyfsm.fsm.Transition}.
	 * It is bidirectional and its opposite is '{@link org.gemoc.sample.legacyfsm.fsm.Transition#getTarget <em>Target</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.gemoc.sample.legacyfsm.fsm.FsmPackage#getState_IncomingTransitions()

...
/**
 * This is the item provider adapter for a {@link org.eclipse.gemoc.example.k3fsm.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						K3fsmPackage.Literals.STATE__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_State_incomingTransitions_feature",
								"_UI_State_type"),
						K3fsmPackage.Literals.STATE__INCOMING_TRANSITIONS, true, false, true, null, null, null));
	}
	...
	protected void addOwningFSMPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_owningFSM_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_owningFSM_feature",
								"_UI_State_type"),
						K3fsmPackage.Literals.STATE__OWNING_FSM, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(K3fsmPackage.Literals.STATE__OUTGOING_TRANSITIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(K3fsmPackage.Literals.STATE__OUTGOING_TRANSITIONS,
				K3fsmFactory.eINSTANCE.createTransition()));
	}

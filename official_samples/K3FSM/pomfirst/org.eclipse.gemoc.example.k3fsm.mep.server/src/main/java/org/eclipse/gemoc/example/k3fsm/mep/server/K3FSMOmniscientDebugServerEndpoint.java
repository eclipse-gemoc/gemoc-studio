...
@ServerEndpoint("/mep/k3fsm/omniscient")
@ApplicationScoped
public class K3FSMOmniscientDebugServerEndpoint {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(K3FSMOmniscientDebugServerEndpoint.class);
    ...
    void onStart(@Observes StartupEvent ev) {               
        LOGGER.info("The K3FSMOmniscientDebugServerEndpoint is starting...");

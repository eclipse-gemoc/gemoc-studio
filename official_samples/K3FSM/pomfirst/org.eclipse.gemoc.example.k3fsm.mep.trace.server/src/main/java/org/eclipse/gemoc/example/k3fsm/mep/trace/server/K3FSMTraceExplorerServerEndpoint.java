...
@ServerEndpoint("/mep/k3fsm/trace/explorer")
@ApplicationScoped
public class K3FSMTraceExplorerServerEndpoint {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(K3FSMTraceExplorerServerEndpoint.class);
    ...
    void onStart(@Observes StartupEvent ev) {               
        LOGGER.info("The K3FSMTraceExplorerServerEndpoint is starting...");

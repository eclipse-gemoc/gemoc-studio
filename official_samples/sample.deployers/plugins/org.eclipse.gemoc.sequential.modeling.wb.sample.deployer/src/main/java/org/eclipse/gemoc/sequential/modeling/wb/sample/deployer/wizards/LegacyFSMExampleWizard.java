...
public class MelangeK3FSMExampleWizard
	...
	protected Collection<ProjectDescriptor> getProjectDescriptors() {		
		...
		projects.add(new ProjectDescriptor(Activator.PLUGIN_ID, "zips/org.eclipse.gemoc.example.melangek3fsm.model_examples.zip", "org.eclipse.gemoc.example.melangek3fsm.model_examples"));
		return projects;
	}
